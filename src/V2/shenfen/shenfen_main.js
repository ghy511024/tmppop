 ...
 */
// __inline ('../../view/shenfenchose.tpl');
// __inline ('shenfenchose_rp.js');

var html_main = require("html-loader!./shenfen.tpl");
var html_main_li = require("html-loader!./shenfen_li.tpl");
var style_main = require("./shenfen__inline.scss");
var tool = require("../common/popTool");
var SFRP = require("./shenfen_rp");
...
var updateUrl = "https://housepostbaseapi.58.com/usertype/add";// 初次选择身份，提交接口
var SF = {
    ctype: null,
    cateid: "",
    cityid: "",
    ...
    _layout: function (list) {
        ...
        tool.addNode(html_main);
        tool.addStyle(style_main);
